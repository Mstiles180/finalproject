...
<body>
    ...
    <footer class="bg-dark text-light py-4 mt-5">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h5><i class="fas fa-handshake me-2"></i>Work Connect</h5>
                    <p class="mb-0">Connecting talented workers with great opportunities.</p>
                </div>
                <div class="col-md-6 text-md-end">
                    <p class="mb-0">&copy; {{ date('Y') }} Work Connect. All rights reserved.</p>
                </div>
            </div>
        </div>
    </footer>
